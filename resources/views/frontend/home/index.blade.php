                                    ...
                                    <div class="title">
                                        <div class="tour-info-line clearfix">
                                            <div class="tour-info fl">
                                                ...
                                                <span
                                                    class="font-style-2 color-grey-3"><strong>{{ $package->tour_duration }}</strong></span>
                                            </div>
                                            <div class="tour-info fl">
                                                <img src="{{ asset('frontend/img/loc_icon_small_grey.png') }}" alt="">
                                                <span class="font-style-2 color-grey-3">{{ $package->subcontinent->sub_continent_name }}</span>
                                            </div>
                                        </div>
...
{{--                                            <i>485 rewies</i>--}}
{{--                                        </div>--}}
                                        <h5>from <strong>BDT {{ $package->tour_price }}/- </strong> /person</h5>
                                        <p class="f-14 color-grey-3"><h6>Hotel</h6> <strong>{{ $package->hotels }}</strong></p><br>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="world-city black-hover">
                            ...
                            <div class="vertical-align">
                                ...
                                <h4 class="world-price color-white">from BDT-<b>{{ $continent->starting_price }} /=</b>
                                </h4>
                                <div class="rate">
                                    <span class="fa fa-star color-yellow"></span>
                                    <span class="fa fa-star color-yellow"></span>
