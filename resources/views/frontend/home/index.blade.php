...
{{--                    <div class="home_slider_background" style="background-image:url( {{ asset('frontend/images/home_slider.jpg') }})"></div>--}}
                    <img class="home_slider_background" src="{{ asset('frontend/images/home_slider.jpg') }}" alt="">
                ...
                @foreach($continents as $continent)
                    <div class="col-lg-4 intro_col mb-5">
                        <div class="intro_item">
                            ...
                            <div class="intro_item_background" style="background-image: url({{ asset('frontend/images/intro_1.jpg') }})"></div>
                            <div
                                class="intro_item_content d-flex flex-column align-items-center justify-content-center">
                                <div class="intro_date">May 25th - June 01st</div>
                                <div class="button intro_button">
                                    <div class="button_bcg"></div>
                                    <a href="{{ route('package.show_package', $continent->id)  }}">see more<span></span><span></span><span></span></a>
                                </div>
