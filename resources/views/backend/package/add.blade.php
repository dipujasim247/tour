                            ...
                            <form action="{{ route('package.store') }}" method="post"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="name">Package Name (Required*) </label>
                                        <input type="text" id="" name="package_name"
                                               value="{{ old('package_name') }}" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" id="" name="tour_duration"
                                               value="{{ old('tour_duration') }}" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" id="" name="tour_price"
                                               value="{{ old('tour_price') }}" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <textarea class="form-control" rows="5" name="tour_details"></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <textarea class="form-control" rows="5" name="tour_price_include"></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <textarea class="form-control" rows="5" name="tour_price_exclude"></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" id="" name="hotels"
                                               value="{{ old('hotels') }}" class="form-control"
                                               placeholder="Hotels">
