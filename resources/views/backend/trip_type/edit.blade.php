                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('trip_type.edit', $tripType->id) }}" method="post"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" id="" name="trip_type"
                                               value="{{ $tripType->trip_type }}" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <textarea class="form-control" rows="5" name="description">{{ $tripType->description }}</textarea>
